...
class ContinuumShard(VisionDataset):
    def __init__(self, root='/home/mjx/课题1代码/GML-master/Regular/Partition/temp_data/processed_data/cora', name='shard_data', data_type='train', k_hop=1, download=True, task_type=0, thres_nodes = 50, first_shard = None, second_shard = None):
