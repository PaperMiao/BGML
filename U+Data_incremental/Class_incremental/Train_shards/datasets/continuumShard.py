...
class ContinuumShard(VisionDataset):
    def __init__(self, root='/home/mjx/GML-master/U+Data_incremental/Class_incremental/Partition/temp_data/processed_data/cora', name='shard_data', data_type='train', k_hop=1, download=True, task_type=0, thres_nodes = 50, first_shard = None, second_shard = None):
        ...
        if data_type == 'train': # data incremental; use test and train as train
            ...
            self.mask = torch.BoolTensor(self.data.test_mask) # use val as test, since val is larger than test
