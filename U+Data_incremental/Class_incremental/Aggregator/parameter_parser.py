...
def parameter_parser():
    ...
    parser.add_argument('--cuda', type=int, default=1, help='specify gpu') ## GPU号
    ...
    parser.add_argument('--load', type=str, default='/home/mjx/GML-master/U+Data_incremental/Class_incremental/Train_shards/shards_models')
    parser.add_argument("--hidden", type=int, nargs="+", default=[90,90])
